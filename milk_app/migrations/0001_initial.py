    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ratingCurrent', models.DecimalField(decimal_places=2, default=0.0, max_digits=4)),
                ('picture', models.ImageField(upload_to=milk_app.models.generate_filename_listingpic)),
                ('date', models.DateField(default=datetime.date.today)),
                ('university', models.CharField(max_length=40)),
                ('slug', models.SlugField(unique=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userName', to='milk_app.userprofile')),
                ('userPrev', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='userNamePrev', to='milk_app.userprofile')),
            ],
            options={
